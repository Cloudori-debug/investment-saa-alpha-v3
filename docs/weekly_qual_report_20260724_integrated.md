...
> **통합본 (업로드용)** · as_of 2026-07-24 · base=WQR-20260724-225030
> - A/E: Cursor 루브릭 초안(공식 CECS 계단·현 제안 8종)
> - C/D: Claude 사실조사 + 원문 재검증(상법 시행령 관보·K-IFRS 1118 금융위 공포)
> - B/F: 비움(선택)
> - 최종 점수·fired는 결재함에서 출처 확인 후 승인
...
제도 이벤트 발생 여부. ired는 true/false만.
**통합 판정:** Cursor 초안(전부 false) vs Claude(상법·IFRS true) → as_of 기준 1차 출처 재검증 후 아래 확정.

### EVENT [commercial_code_enforcement_decrees]
- fired: true
- 근거: 상법 시행령 일부개정(대통령령 제36511호, 전자주주총회 등)이 2026-07-14 국무회의 의결·2026-07-21 공포·시행(관보/법령 게재). 확정 인정 기준(관보 게재) 충족. (세부 전자주총 의무는 2027-01-01부터인 조항과 구분 — 시행령 자체 확정은 true.)
- 출처:
  - https://lbox.kr/statute/%EC%83%81%EB%B2%95%EC%8B%9C%ED%96%89%EB%A0%B9
  - https://www.taxtimes.co.kr/news/article.html?no=276013
  - https://www.hankyung.com/article/202607144355i

### EVENT [msci_dm_index_inclusion_confirmed]
- fired: false
- 근거: MSCI 2026 Annual Market Classification Review(2026-06-23)에서 한국 DM 편입 미확정·워치리스트 미등재. EM 유지. 공식 편입 발표 없음.
- 출처:
...
- fired: true
- 근거: K-IFRS 제1118호(재무제표의 표시와 공시)가 회계기준원 심의·의결 후 증선위·금융위 보고를 거쳐 2025-12월 공포. 확정 인정 기준(금융위/KASB 확정 고시) 충족. 의무적용은 2027-01-01 이후 개시 사업연도(조기적용 허용).
- 출처:
  - https://www.fsc.go.kr/no010101/85886
  - https://www.mt.co.kr/stock/2025/12/18/2025121810052754674
...
### THESIS
- damage: false
- 근거: as_of 2026-07-24 기준 주주환원·지배구조·밸류업 제도는 후퇴·유예가 아니라 강화 방향(상법 시행령 공포, 3%룰·분리선출 일정 진행). 경제단체 반대 보도는 있으나 법안·시행령 유예·철회 확정 공시는 확인되지 않음. 개별 실적·주가 변동만으로 damage:true 하지 않음.
- 출처:
  - https://www.fnnews.com/news/202607221501452214
  - https://lbox.kr/statute/%EC%83%81%EB%B2%95%EC%8B%9C%ED%96%89%EB%A0%B9
